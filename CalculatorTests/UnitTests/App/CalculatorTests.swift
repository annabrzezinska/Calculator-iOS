...
class CalculatorTests: XCTestCase {
    ...
    func testInput5Equal2_ItReturns2() {
        ...
        XCTAssertEqual(displayResult, State(reducedInput: ["5", "=", "2"], displayValue: "2"))
    }
    ...
    func testInput0Minus2Minus_ItReturnsMinus2() {
        let displayResult = calculate(input: ["0", "-", "2", "-"])
        XCTAssertEqual(displayResult, State(reducedInput: ["-2", "-"], displayValue: "-2"))
    }
    
    func testInput0Divide3Equal_ItReturns0() {
        let displayResult = calculate(input: ["0", "/", "3", "="])
    ...
    func testWhenTappedOn7PlusDot2_ItDisplays0Dot2() {
        ...
        XCTAssertEqual(displayResult, State(reducedInput: ["7", "+", "0", ".", "2"], displayValue: "0.2"))
    }
